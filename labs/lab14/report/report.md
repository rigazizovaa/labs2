...
1. Для выполнения лабораторной работы создадим четыре файла с помощщью команды touch и откроем их в emacs для редактирования (рис. [-@fig:001]).

![Создание файлов](image/1.png){ #fig:001 width=70% }

2. Изменим код программ, представленные в тексте задания лабораторной работы.
В файл common.h добавим стандартные заголовочные файлы unistd.h и time.h, которые необходимы для работы других файлов (рис. [-@fig:002]). Этот файл предназначен для заголовочных файлов, чтобы не прописывать их в других программах каждый раз.

![Common.h](image/2.png){ #fig:002 width=70% }

Затем в файл server.c добавим цикл while для контроля за временем работы сервера (рис. [-@fig:003]) и (рис. [-@fig:004]), причем время от начала работы сервера и до настоящего не должно превышать 30 секунд.

![Server.c (часть 1)](image/3.png){ #fig:003 width=70% }

![Server.c (часть 2)](image/4.png){ #fig:004 width=70% }

В файл client.c добавим цикл for, который будет отвечать за количество сообщений о текущем времени (4 сообщения), и команду sleep(5) для остановки работы клиента через 5 секунд. Также я изменила выводимое сообщение на текущее время (рис. [-@fig:005]). 

![Client.c](image/9.png){ #fig:005 width=70% }

Makefile оставила без изменения (рис. [-@fig:006]).

![Makefile](image/6.png){ #fig:006 width=70% }

3. Используя команду make all (рис. [-@fig:007]), скомпилируем необходимые для работы файлы.

![Компиляция файлов](image/7.png){ #fig:007 width=70% }
